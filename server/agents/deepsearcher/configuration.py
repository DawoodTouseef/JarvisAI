...
from .agent import ChainOfRAG, DeepSearch, NaiveRAG
from .agent.rag_router import RAGRouter
from .embedding.base import BaseEmbedding
from .llm.base import BaseLLM
from .loader.file_loader.base import BaseLoader
from .loader.web_crawler.base import BaseCrawler
from .loader.web_search.base import BaseWebSearch
from .vector_db.base import BaseVectorDB

current_dir = os.path.dirname(os.path.abspath(__file__))
DEFAULT_CONFIG_YAML_PATH = os.path.join(current_dir, "config.yaml")

FeatureType = Literal["llm", "embedding", "file_loader", "web_crawler", "vector_db", "web_search"]
...
class ModuleFactory:
    ...
    def _create_module_instance(self, feature: FeatureType, module_name: str):
        ...
        # e.g.
        # feature = "file_loader"
        # module_name = ".loader.file_loader"
        class_name = self.config.provide_settings[feature]["provider"]
        try:
            module = importlib.import_module(module_name, package=__package__)
        except (ImportError, ValueError):
            # Fallback for when __package__ is None or other import issues
            if module_name.startswith("."):
                full_module_name = f"server.agents.deepsearcher{module_name}"
    ...
    def create_llm(self) -> BaseLLM:
        ...
        """
        return self._create_module_instance("llm", ".llm")
    ...
    def create_embedding(self) -> BaseEmbedding:
        ...
        """
        return self._create_module_instance("embedding", ".embedding")
    ...
    def create_file_loader(self) -> BaseLoader:
        ...
        """
        return self._create_module_instance("file_loader", ".loader.file_loader")
    ...
    def create_web_crawler(self) -> BaseCrawler:
        ...
        """
        return self._create_module_instance("web_crawler", ".loader.web_crawler")

    def create_web_search(self):
        """
        Create an instance of a web search engine.
        """
        return self._create_module_instance("web_search", ".loader.web_search")
    ...
    def create_vector_db(self) -> BaseVectorDB:
        ...
        """
        return self._create_module_instance("vector_db", ".vector_db")
...
def init_config(config: Configuration):
    ...
    web_search = module_factory.create_web_search()
