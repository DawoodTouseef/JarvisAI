...
SQL_TEMPLATES = {
    ...
    "has_collection": "select count(*) as rowcnt from ._COLLECTION_INFO where collection=:collection and status=1",
    "list_collections": "select collection,description from ._COLLECTION_INFO where status=1",
